...
const translations: Translations = {
	'lv': {
		dictionary: {
			...
			'Please try a different phrase or check the spelling.': 'Lūdzu, izmēģiniet citu frāzi vai pārbaudiet pareizrakstību.',
		...
		getPluralForm: ( n: number ) => (n % 10 == 1 && n % 100 != 11 ? 0 : n != 0 ? 1 : 2)
	}
};
