 ...
 */
import ClassicFloatingEditorUI from '../ui/ClassicFloatingEditorUI.js';
import ClassicFloatingEditorUIView from '../ui/ClassicFloatingEditorUIView.js';
import {
	Editor,
	Context,
	ElementApiMixin,
 ...
 */
export default class ClassicFloatingEditor extends ElementApiMixin( Editor ) {
	/**
	 * @inheritDoc
	 */
