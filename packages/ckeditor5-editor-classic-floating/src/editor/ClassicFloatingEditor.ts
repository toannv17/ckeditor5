...
/**
 * @module editor-classic/classicfloatingeditor
 */

import ClassicFloatingEditorUI from '../ui/ClassicFloatingEditorUI';
 ...
 * {@link module:editor-classic/classicfloatingeditor~ClassicFloatingEditor.create `ClassicFloatingEditor.create()`} method.
 *
 ...
 */
export default class ClassicFloatingEditor extends DataApiMixin(ElementApiMixin(Editor)) {
	/**
	 * @inheritDoc
	 */
	public readonly ui: ClassicFloatingEditorUI;

	/**
	 * Creates an instance of the classic editor.
	 *
	 * **Note:** do not use the constructor to create editor instances. Use the static
	 * {@link module:editor-classic/classicfloatingeditor~ClassicFloatingEditor.create `ClassicFloatingEditor.create()`} method instead.
	 *
	...
	protected constructor(sourceElementOrData: HTMLElement | string, config: EditorConfig = {}) {
		...
		this.ui = new ClassicFloatingEditorUI(this, view);
	 ...
	 * and the {@link module:editor-classic/classicfloatingeditorui~ClassicFloatingEditorUI#element editor element} will replace the passed element
	 ...
	 * It is available under the {@link module:editor-classic/classicfloatingeditorui~ClassicFloatingEditorUI#element `editor.ui.element`} property.
	 *
	 * @param config The editor configuration.
	 * @returns A promise resolved once the editor is ready. The promise resolves with the created editor instance.
	 */
	public static override create(sourceElementOrData: HTMLElement | string, config: EditorConfig = {}): Promise<ClassicFloatingEditor> {
