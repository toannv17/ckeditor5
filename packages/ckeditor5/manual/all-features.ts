...
import { AutoImage, ImageResize, ImageInsert } from 'toannv-ckeditor5-image';
...
import { MediaEmbedResize, MediaEmbedStyle, MediaEmbedToolbar } from 'toannv-ckeditor5-media-embed';
