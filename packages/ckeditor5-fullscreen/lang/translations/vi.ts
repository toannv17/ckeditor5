...
const translations: Translations = {
	'vi': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Vào chế độ toàn màn hình',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Thoát chế độ toàn màn hình',
