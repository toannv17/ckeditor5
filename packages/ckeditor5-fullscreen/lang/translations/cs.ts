...
const translations: Translations = {
	'cs': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Přejít do režimu celé obrazovky',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Opustit režim celé obrazovky',
			...
			'Document outline': 'Osnova dokumentu',
			...
			'Show left sidebar': 'Zobrazit levý postranní panel',
