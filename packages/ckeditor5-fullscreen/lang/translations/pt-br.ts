...
const translations: Translations = {
	'pt-br': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Entrar no modo tela cheia',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Sair do modo tela cheia',
			...
			'Toggle fullscreen mode': 'Alternar modo tela cheia',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Contorno do documento',
