...
const translations: Translations = {
	'ru': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Войти в полноэкранный режим',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Выйти из полноэкранного режима',
			...
			'Toggle fullscreen mode': 'Переключить полноэкранный режим',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Состав документа',
			...
			'Show left sidebar': 'Показать левую боковую панель',
