...
const translations: Translations = {
	'ca': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Mode Entra a la pantalla completa',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Surt del mode de pantalla completa',
			...
			'Toggle fullscreen mode': 'Activa el mode de pantalla completa',
			...
			'Show left sidebar': 'Mostrar el menú lateral esquerra',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Amagar el menú lateral esquerra',
			// Label for a button that toggles the left sidebar
			'Toggle sidebar': 'Alternar al menú lateral'
		}
	}
};
