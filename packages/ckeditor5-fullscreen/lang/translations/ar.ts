...
const translations: Translations = {
	'ar': {
		dictionary: {
			...
			'Enter fullscreen mode': 'الدخول في وضع ملء الشاشة',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'مغادرة وضع ملء الشاشة',
			...
			'Show left sidebar': 'إظهار الشريط الجانبي الأيسر',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'إخفاء الشريط الجانبي الأيسر',
