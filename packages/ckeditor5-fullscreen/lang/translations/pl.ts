...
const translations: Translations = {
	'pl': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Włącz tryb pełnoekranowy',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Wyłącz tryb pełnoekranowy',
			...
			'Document outline': 'Zarys dokumentu',
			...
			'Show left sidebar': 'Pokaż lewy pasek boczny',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Ukryj lewy pasek boczny',
