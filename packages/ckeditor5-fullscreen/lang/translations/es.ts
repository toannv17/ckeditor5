...
const translations: Translations = {
	'es': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Entrar al modo de pantalla completa',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Salir del modo de pantalla completa',
			...
			'Toggle fullscreen mode': 'Alternar modo de pantalla completa',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Boceto del documento',
			...
			'Show left sidebar': 'Mostrar barra lateral izquierda',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Ocultar la barra lateral izquierda',
			// Label for a button that toggles the left sidebar
			'Toggle sidebar': 'Activar o desactivar la barra lateral'
		}
	}
};
