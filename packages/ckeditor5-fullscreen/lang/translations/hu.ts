...
const translations: Translations = {
	'hu': {
		dictionary: {
			...
			'Leave fullscreen mode': 'Kilépés a teljes képernyőből',
			...
			'Toggle fullscreen mode': 'Váltás teljes képernyőre',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Dokumentum vázlata',
			...
			'Show left sidebar': 'Bal oldalsáv megjelenítése',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Bal oldalsáv elrejtése',
			// Label for a button that toggles the left sidebar
			'Toggle sidebar': 'Oldalsáv megjelenítése/elrejtése'
		}
	}
};
