...
const translations: Translations = {
	'el': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Εισαγωγή σε λειτουργία πλήρους οθόνης',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Αποχώρηση από τη λειτουργία πλήρους οθόνης',
			...
			'Document outline': 'Περιεχόμενο εγγράφου',
			...
			'Show left sidebar': 'Εμφάνιση αριστερής πλαϊνής γραμμής',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Απόκρυψη αριστερής πλαϊνής γραμμής',
