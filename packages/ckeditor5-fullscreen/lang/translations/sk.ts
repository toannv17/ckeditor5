...
const translations: Translations = {
	'sk': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Otvoriť režim celej obrazovky',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Opustiť režim celej obrazovky',
