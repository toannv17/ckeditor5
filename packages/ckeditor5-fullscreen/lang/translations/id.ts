...
const translations: Translations = {
	'id': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Masuk ke mode layar penuh',
			...
			'Connected users': 'Pengguna yang terhubung',
			// Tooltip for a button that shows the left sidebar
			'Show left sidebar': 'Tampilkan panel kiri',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Sembunyikan panel kiri',
			// Label for a button that toggles the left sidebar
			'Toggle sidebar': 'Alihkan panel samping'
		}
	}
};
