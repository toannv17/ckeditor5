...
const translations: Translations = {
	'no': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Gå til fullskjermmodus',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Forlat fullskjermmodus',
			...
			'Toggle fullscreen mode': 'Bytt fullskjermmodus',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Dokumentoversikt',
			...
			'Show left sidebar': 'Vis venstre sidestolpe',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Skjul venstre sidestolpe',
