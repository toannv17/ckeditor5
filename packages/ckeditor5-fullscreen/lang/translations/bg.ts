...
const translations: Translations = {
	'bg': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Вход в режим на цял екран',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Изход от режима на цял екран',
			...
			'Toggle fullscreen mode': 'Превключване на режима на цял екран',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Вид на документа',
			...
			'Show left sidebar': 'Покажи лявата странична лента',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Скрий лявата странична лента',
			// Label for a button that toggles the left sidebar
			'Toggle sidebar': 'Превключи на странична лента'
		}
	}
};
