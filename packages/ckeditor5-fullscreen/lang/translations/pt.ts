...
const translations: Translations = {
	'pt': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Entrar em modo de ecrã inteiro',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Sair de modo de ecrã inteiro',
			...
			'Toggle fullscreen mode': 'Alternar modo de ecrã inteiro',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Esboço do documento',
			...
			'Show left sidebar': 'Exibir a barra lateral esquerda',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Ocultar a barra lateral esquerda',
			// Label for a button that toggles the left sidebar
			'Toggle sidebar': 'Exibir/Ocultar a barra lateral'
		}
	}
};
