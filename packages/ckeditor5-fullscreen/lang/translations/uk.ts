...
const translations: Translations = {
	'uk': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Задіяти повноекранний режим',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Вийти з повноекранного режиму',
			...
			'Toggle fullscreen mode': 'Увімкнути повноекранний режим',
			...
			'Hide left sidebar': 'Сховати ліву бічну панель',
			// Label for a button that toggles the left sidebar
			'Toggle sidebar': 'Показати/сховати бічну панель'
		}
	}
};
