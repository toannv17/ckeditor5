...
const translations: Translations = {
	'da': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Gå i fuldskærmstilstand',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Forlad fuldskærmstilstand',
