...
const translations: Translations = {
	'nl': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Volledig scherm openen',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Volledig scherm verlaten',
