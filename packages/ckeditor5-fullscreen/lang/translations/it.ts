...
const translations: Translations = {
	'it': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Entra in modalità a schermo intero',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Esci dalla modalità a schermo intero',
			...
			'Document outline': 'Schema del documento',
			...
			'Hide left sidebar': 'Nascondi barra laterale sinistra',
