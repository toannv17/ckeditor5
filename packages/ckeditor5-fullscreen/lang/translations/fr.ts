...
const translations: Translations = {
	'fr': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Accéder au mode plein écran',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Quitter le mode plein écran',
			...
			'Show left sidebar': 'Afficher la barre latérale gauche',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Masquer la barre latérale gauche',
			// Label for a button that toggles the left sidebar
			'Toggle sidebar': 'Basculer vers la barre latérale'
		}
	}
};
