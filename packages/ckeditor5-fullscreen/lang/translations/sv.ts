...
const translations: Translations = {
	'sv': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Gå in i helskärmsläge',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Lämna helskärmsläget',
			...
			'Toggle fullscreen mode': 'Skifta helskärmsläge',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Dokumentöversikt',
			...
			'Show left sidebar': 'Visa vänster sidopanel',
