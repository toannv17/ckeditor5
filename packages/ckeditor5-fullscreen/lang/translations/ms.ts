...
const translations: Translations = {
	'ms': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Masukkan mod skrin penuh',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Tinggalkan mod skrin penuh',
