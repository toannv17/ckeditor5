...
const translations: Translations = {
	'hi': {
		dictionary: {
			...
			'Enter fullscreen mode': 'फ़ुलस्क्रीन मोड में प्रवेश करें',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'फ़ुलस्क्रीन मोड छोड़ें',
