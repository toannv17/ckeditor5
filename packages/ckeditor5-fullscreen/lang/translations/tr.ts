...
const translations: Translations = {
	'tr': {
		dictionary: {
			...
			'Enter fullscreen mode': 'Tam ekran moduna gir',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'Tam ekran modundan çık',
			...
			'Toggle fullscreen mode': 'Tam ekran modunu aç/kapat',
			// Label for a sidebar header that contains a document outline
			'Document outline': 'Belge ana hatları',
			...
			'Show left sidebar': 'Sol kenar çubuğunu göster',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'Sol kenar çubuğunu gizle',
