...
const translations: Translations = {
	'bn': {
		dictionary: {
			...
			'Enter fullscreen mode': 'ফুলস্ক্রীন মোডে প্রবেশ করুন',
			// Label for a toolbar button that leaves the fullscreen when pressed
			'Leave fullscreen mode': 'ফুলস্ক্রিন মোড ছেড়ে যান',
			...
			'Toggle fullscreen mode': 'ফুলস্ক্রিন মোড টগল করুন',
			...
			'Connected users': 'সংযুক্ত ব্যবহারকারী',
			// Tooltip for a button that shows the left sidebar
			'Show left sidebar': 'বাম সাইডবার দেখান',
			// Tooltip for a button that hides the left sidebar
			'Hide left sidebar': 'বাম সাইডবার লুকান',
