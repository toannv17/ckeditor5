...
import type { UploadResponse } from '@ckeditor-nonkey/ckeditor5-upload';
import { EmitterMixin, CKEditorError, type EmitterMixinConstructor } from '@ckeditor-nonkey/ckeditor5-utils';
