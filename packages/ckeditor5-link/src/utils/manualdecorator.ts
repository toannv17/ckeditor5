...
import { ObservableMixin, type ArrayOrItem, type ObservableMixinConstructor } from 'toannv-ckeditor5-utils';
import type { MatcherObjectPattern } from 'toannv-ckeditor5-engine';
