...
import { ObservableMixin, type ArrayOrItem, type ObservableMixinConstructor } from '@ckeditor-nonkey/ckeditor5-utils';
import type { MatcherObjectPattern } from '@ckeditor-nonkey/ckeditor5-engine';
