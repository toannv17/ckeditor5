...
import { Collection, diff, first, toMap } from '@ckeditor-nonkey/ckeditor5-utils';
import { ModelLivePosition, type ModelRange, type ModelItem, type ModelTextProxy } from '@ckeditor-nonkey/ckeditor5-engine';
