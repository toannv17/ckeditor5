...
const translations: Translations = {
	'el': {
		dictionary: {
			...
			'Link properties': 'Ιδιότητες συνδέσμου',
			...
			'Displayed text': 'Εμφανιζόμενο κείμενο',
			// Placeholder shown when placeholder items view is empty.
			'No links available': 'Δεν υπάρχουν διαθέσιμοι σύνδεσμοι',
			// The label of the switch button shown when link has empty href attribute.
			'This link has no URL': 'Αυτός ο σύνδεσμος δεν έχει URL'
		}
	}
};
