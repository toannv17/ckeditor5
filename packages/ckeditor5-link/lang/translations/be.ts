...
const translations: Translations = {
	'be': {
		dictionary: {
			...
			'Link URL': 'Спасылка URL',
			// An error text displayed when user attempted to enter an empty URL.
			'Link URL must not be empty.': 'URL-адрас спасылкі не павінен быць пустым.',
			// Label for the image link button.
			'Link image': 'Спасылка на відарыс',
			...
			'Move out of a link': 'Выйсці з спасылкі',
