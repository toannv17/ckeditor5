...
const translations: Translations = {
	'ms': {
		dictionary: {
			...
			'Remove bookmark': 'Alih keluar penanda halaman',
			...
			'Bookmark name': 'Nama penanda halaman',
			// The description of bookmark input in the bookmark insert form.
			'Enter the bookmark name without spaces.': 'Masukkan nama penanda halaman tanpa ruang.',
			// The error message. Displayed when the bookmark name is empty.
			'Bookmark must not be empty.': 'Penanda halaman tidak boleh kosong.',
			// The error message. Displayed when provided name includes spaces.
			'Bookmark name cannot contain space characters.': 'Nama penanda halaman tidak boleh mengandungi aksara ruang.',
			// The error message. Displayed when provided name already exists.
			'Bookmark name already exists.': 'Nama penanda halaman sudah wujud.',
			...
			'No bookmarks available.': 'Tiada penanda halaman tersedia.',
