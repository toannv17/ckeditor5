...
import { EmitterMixin, type ArrayOrItem, type EmitterMixinConstructor } from '@ckeditor-nonkey/ckeditor5-utils';

import type { ViewDowncastWriter, DowncastHighlightDescriptor } from '@ckeditor-nonkey/ckeditor5-engine';
