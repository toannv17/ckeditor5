...
import { ClassicEditor, SpecialCharacters, SpecialCharactersEssentials } from '@ckeditor-nonkey/ckeditor5';
...
<code-switcher>
```js
import { ClassicEditor, SpecialCharacters, SpecialCharactersCurrency, SpecialCharactersMathematical } from '@ckeditor-nonkey/ckeditor5';
