...
import type FloatingEditorUIView from './FloatingEditorUIView';

/**
 * The classic editor UI class.
 */
export default class FloatingEditorUI extends EditorUI {
	/**
	 * The main (top–most) view of the editor UI.
	 */
	public readonly view: FloatingEditorUIView;
	 ...
	 */
	constructor( editor: Editor, view: FloatingEditorUIView ) {
		super( editor );
	 ...
	 * {@link module:editor-classic/classiceditoruiview~FloatingEditorUIView#stickyPanel} that pins to the
