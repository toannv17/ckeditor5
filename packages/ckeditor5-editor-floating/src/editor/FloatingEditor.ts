...
import FloatingEditorUI from '../ui/floatingeditorui';
import FloatingEditorUIView from '../ui/FloatingEditorUIView';
 ...
 */
export default class FloatingEditor extends DataApiMixin(ElementApiMixin(Editor)) {
	/**
	 * @inheritDoc
	 */
	public readonly ui: FloatingEditorUI;
	...
	protected constructor(sourceElementOrData: HTMLElement | string, config: EditorConfig & {
		...
		const view = new FloatingEditorUIView(this.locale, this.editing.view, {
			shouldToolbarGroupWhenFull,
			containerElement: config.containerElement,
			panelAbsolute: config.panelAbsolute
		});

		this.ui = new FloatingEditorUI(this, view);
	 ...
	 */
	public static override create(sourceElementOrData: HTMLElement | string, config: EditorConfig = {}): Promise<FloatingEditor> {
