...
<code-switcher>
```js
import { ClassicEditor, Image, ImageResizeEditing, ImageResizeHandles } from '@ckeditor-nonkey/ckeditor5';
...
<code-switcher>
```js
import { ClassicEditor, Image, ImageResizeButtons, ImageResizeEditing, ImageToolbar } from '@ckeditor-nonkey/ckeditor5';
...
<code-switcher>
```js
import { ClassicEditor, Image, ImageResize } from '@ckeditor-nonkey/ckeditor5';
