...
import { View, ButtonView, addKeyboardHandlingForGrid, type ViewCollection } from '@ckeditor-nonkey/ckeditor5-ui';

import { KeystrokeHandler, FocusTracker, type Locale } from '@ckeditor-nonkey/ckeditor5-utils';
