...
import { Collection, type EventInfo } from '@ckeditor-nonkey/ckeditor5-utils';
import type { EditingView, Model, ModelElement, ModelDocumentChangeEvent } from '@ckeditor-nonkey/ckeditor5-engine';
