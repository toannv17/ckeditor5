...
import { Plugin, type Editor, type Command, type PluginDependenciesOf } from '@ckeditor-nonkey/ckeditor5-core';
import { IconTableCellProperties } from '@ckeditor-nonkey/ckeditor5-icons';
import {
	ButtonView,
	clickOutsideHandler,
	ContextualBalloon,
...
import type { GetCallback, ObservableChangeEvent } from '@ckeditor-nonkey/ckeditor5-utils';
