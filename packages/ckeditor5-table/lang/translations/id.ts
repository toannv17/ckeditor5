...
const translations: Translations = {
	'id': {
		dictionary: {
			...
			'Insert table layout': 'Sisipkan tata letak tabel',
			...
			'Table Alignment': 'Perataan Tabel',
			...
			'Align table to the left with text wrapping': 'Ratakan tabel ke kiri dengan pembungkusan teks',
			...
			'Center table with no text wrapping': 'Pusatkan tabel tanpa pembungkusan teks',
			...
			'Align table to the right with text wrapping': 'Ratakan tabel ke kanan dengan pembungkusan teks',
			...
			'Align table to the left with no text wrapping': 'Ratakan tabel ke kiri tanpa pembungkusan teks',
			...
			'Align table to the right with no text wrapping': 'Ratakan tabel ke kanan tanpa pembungkusan teks',
			...
			'Table type options': 'Opsi jenis tabel'
		}
	}
};
