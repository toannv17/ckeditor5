...
const translations: Translations = {
	'cs': {
		dictionary: {
			...
			'Insert table layout': 'Vložit rozvržení tabulky',
			...
			'Align table to the left with text wrapping': 'Zarovnat tabulku vlevo s obtékáním textu',
			...
			'Center table with no text wrapping': 'Vycentrovat tabulku bez zalomení textu',
			...
			'Align table to the right with text wrapping': 'Zarovnat tabulku vpravo s obtékáním textu',
			...
			'Align table to the left with no text wrapping': 'Zarovnat tabulku vlevo bez zalomení textu',
			...
			'Align table to the right with no text wrapping': 'Zarovnat tabulku vpravo bez zalomení textu',
			...
			'Table type options': 'Možnosti typu tabulky'
		}
	}
};
