...
const translations: Translations = {
	'tr': {
		dictionary: {
			...
			'Insert table layout': 'Tablo düzeni ekle',
			...
			'Table Alignment': 'Tablo Hizalama',
			...
			'Align table to the left with text wrapping': 'Metin kaydırma yaparak tabloyu sola hizala',
			...
			'Center table with no text wrapping': 'Metin kaydırma yapmadan tabloyu ortala',
			...
			'Align table to the right with text wrapping': 'Metin kaydırma yaparak tabloyu sağa hizala',
			...
			'Align table to the left with no text wrapping': 'Metin kaydırma yapmadan tabloyu sola hizala',
			...
			'Align table to the right with no text wrapping': 'Metin kaydırma yapmadan tabloyu sağa hizala',
