...
const translations: Translations = {
	'pt-br': {
		dictionary: {
			...
			'Insert table layout': 'Inserir layout de tabela',
			...
			'Table Alignment': 'Alinhamento de tabela',
			...
			'Align table to the left with text wrapping': 'Alinhar tabela à esquerda com quebra de texto',
			...
			'Center table with no text wrapping': 'Centralizar tabela sem quebra de texto',
			...
			'Align table to the right with text wrapping': 'Alinhar tabela à direita com quebra de texto',
			...
			'Align table to the left with no text wrapping': 'Alinhar tabela à esquerda sem quebra de texto',
			...
			'Align table to the right with no text wrapping': 'Alinhar tabela à direita sem quebra de texto',
			...
			'Layout table': 'Tabela de layouts',
			...
			'Table type options': 'Opções de tipo de tabela'
		}
	}
};
