...
const translations: Translations = {
	'vi': {
		dictionary: {
			...
			'Insert table layout': 'Chèn bố cục bảng',
			...
			'Align table to the left with text wrapping': 'Căn bảng sang trái (có văn bản bao quanh)',
			...
			'Center table with no text wrapping': 'Căn bảng vào giữa (không có văn bản bao quanh)',
			...
			'Align table to the right with text wrapping': 'Căn bảng sang phải (có văn bản bao quanh)',
			...
			'Align table to the left with no text wrapping': 'Căn bảng sang trái (không có văn bản bao quanh)',
			...
			'Align table to the right with no text wrapping': 'Căn bảng sang phải (không có văn bản bao quanh)',
			...
			'Table type options': 'Tùy chọn loại bảng'
		}
	}
};
