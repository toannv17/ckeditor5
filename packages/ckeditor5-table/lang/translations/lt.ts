...
const translations: Translations = {
	'lt': {
		dictionary: {
			...
			'Insert table layout': 'Įterpti lentelės maketą',
			...
			'Footer row': 'Puslapinės poraštės eilutė',
			...
			'Table Alignment': 'Lentelės išlyginimas',
			...
			'Align table to the left with text wrapping': 'Išlyginti lentelę į kairę su teksto apvadu',
			...
			'Center table with no text wrapping': 'Vidurinis staliukas be teksto apvyniojimo',
			...
			'Align table to the right with text wrapping': 'Išlyginti lentelę į dešinę su teksto apvadu',
			...
			'Align table to the left with no text wrapping': 'Išlyginti lentelę į kairę be teksto apvyniojimo',
			...
			'Align table to the right with no text wrapping': 'Išlyginti lentelę į dešinę be teksto apvyniojimo',
			...
			'Table type options': 'Lentelės tipo parinktys'
		}
	}
};
