...
const translations: Translations = {
	'zh': {
		dictionary: {
			...
			'Align table to the left with text wrapping': '表格靠左對齊，文字自動換行',
			...
			'Center table with no text wrapping': '表格置中，文字不換行',
			...
			'Align table to the right with text wrapping': '表格靠右對齊，文字自動換行',
			...
			'Align table to the left with no text wrapping': '表格靠左對齊，文字不換行',
			...
			'Align table to the right with no text wrapping': '表格靠右對齊，文字自動換行',
