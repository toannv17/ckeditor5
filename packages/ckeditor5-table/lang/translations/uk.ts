...
const translations: Translations = {
	'uk': {
		dictionary: {
			...
			'Insert table layout': 'Вставити формат таблиці',
			...
			'Footer row': 'Рядок нижнього колонтитулу',
			...
			'Table Alignment': 'Вирівнювання таблиці',
			...
			'Align table to the left with text wrapping': 'Вирівняти таблицю по лівому краю з обтіканням текстом',
			...
			'Center table with no text wrapping': 'Вирівняти таблицю по центру без обтікання текстом',
			...
			'Align table to the right with text wrapping': 'Вирівняти таблицю по правому краю з обтіканням текстом',
			...
			'Align table to the left with no text wrapping': 'Вирівняти таблицю по лівому краю без обтікання текстом',
			...
			'Align table to the right with no text wrapping': 'Вирівняти таблицю по правому краю без обтікання текстом',
			...
			'Table type options': 'Опції типу таблиці'
		}
	}
};
