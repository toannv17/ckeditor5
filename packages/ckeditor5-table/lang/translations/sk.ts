...
const translations: Translations = {
	'sk': {
		dictionary: {
			...
			'Insert table layout': 'Vložiť rozloženie tabuľky',
			...
			'Table Alignment': 'Zarovnanie tabuľky',
			...
			'Align table to the left with text wrapping': 'Zarovnať tabuľku doľava s obtekaním textu',
			...
			'Center table with no text wrapping': 'Zarovnať tabuľku na stred bez obtekania textu',
			...
			'Align table to the right with text wrapping': 'Zarovnať tabuľku doprava s obtekaním textu',
			...
			'Align table to the left with no text wrapping': 'Zarovnať tabuľku doľava bez obtekania textu',
			...
			'Align table to the right with no text wrapping': 'Zarovnať tabuľku doprava bez obtekania textu',
			...
			'Table type options': 'Možnosti typu tabuľky'
		}
	}
};
