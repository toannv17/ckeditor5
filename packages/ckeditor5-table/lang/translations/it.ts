...
const translations: Translations = {
	'it': {
		dictionary: {
			...
			'Insert table layout': 'Inserisci layout della tabella',
			...
			'Footer row': 'Riga del piè di pagina',
			...
			'Table Alignment': 'Allineamento della tabella',
			...
			'Align table to the left with text wrapping': 'Allinea la tabella a sinistra con disposizione del testo',
			...
			'Center table with no text wrapping': 'Centra la tabella senza disposizione del testo',
			...
			'Align table to the right with text wrapping': 'Allinea la tabella a destra con disposizione del testo',
			...
			'Align table to the left with no text wrapping': 'Allinea la tabella a sinistra senza disposizione del testo',
			...
			'Align table to the right with no text wrapping': 'Allinea la tabella a destra senza disposizione del testo',
			...
			'Table type options': 'Opzioni tipo di tabella'
		}
	}
};
