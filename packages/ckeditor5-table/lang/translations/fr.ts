...
const translations: Translations = {
	'fr': {
		dictionary: {
			...
			'Insert table layout': 'Insérer une mise en page de tableau',
			...
			'Footer row': 'Ligne de pied de page',
			...
			'Table Alignment': 'Alignement des tableaux',
			...
			'Align table to the left with text wrapping': 'Aligner le tableau à gauche avec habillage de texte',
			...
			'Center table with no text wrapping': 'Tableau centré sans habillage de texte',
			...
			'Align table to the right with text wrapping': 'Aligner le tableau à droite avec habillage de texte',
			...
			'Align table to the left with no text wrapping': 'Aligner le tableau à gauche sans habillage de texte',
			...
			'Align table to the right with no text wrapping': 'Aligner le tableau à droite sans habillage de texte',
			...
			'Table type options': 'Options de type de tableau'
		}
	}
};
