...
const translations: Translations = {
	'ms': {
		dictionary: {
			...
			'Insert table layout': 'Sisipkan tataletak jadual',
			...
			'Table Alignment': 'Penjajaran Jadual',
			...
			'Align table to the left with text wrapping': 'Align',
			...
			'Center table with no text wrapping': 'Center',
			...
			'Align table to the right with text wrapping': 'Jajarkan jadual ke kanan dengan pembalut teks',
			...
			'Align table to the left with no text wrapping': 'Jajarkan jadual ke kiri tanpa pembalut teks',
			...
			'Align table to the right with no text wrapping': 'Align',
			...
			'Table type options': 'Pilihan jenis jadual'
		}
	}
};
