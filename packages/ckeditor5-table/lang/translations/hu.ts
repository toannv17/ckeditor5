...
const translations: Translations = {
	'hu': {
		dictionary: {
			...
			'Insert table layout': 'Táblázat elrendezés beillesztése',
			...
			'Table Alignment': 'Táblázatigazítás',
			...
			'Align table to the left with text wrapping': 'Táblázat balra igazítása a szöveg sortördelésével',
			...
			'Center table with no text wrapping': 'Táblázat középre igazítása a szöveg sortördelése nélkül',
			...
			'Align table to the right with text wrapping': 'Táblázat jobbra igazítása a szöveg sortördelésével',
			...
			'Align table to the left with no text wrapping': 'Táblázat balra igazítása a szöveg sortördelése nélkül',
			...
			'Align table to the right with no text wrapping': 'Táblázat jobbra igazítása a szöveg sortördelése nélkül',
			...
			'Table layout': 'Táblázat elrendezés',
			// The accessible label of the layout table type dropdown button.
			'Layout table': 'Táblázat elrendezése',
