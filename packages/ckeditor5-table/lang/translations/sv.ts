...
const translations: Translations = {
	'sv': {
		dictionary: {
			...
			'Insert table layout': 'Infoga tabellayout',
			...
			'Align table to the left with text wrapping': 'Justera tabellen till vänster med textomslag',
			...
			'Center table with no text wrapping': 'Centrerad tabell utan textomslag',
			...
			'Align table to the right with text wrapping': 'Justera tabellen till höger med textomslag',
			...
			'Align table to the left with no text wrapping': 'Justera tabellen till vänster utan textomslag',
			...
			'Align table to the right with no text wrapping': 'Justera tabellen till höger utan textomslag',
			...
			'Table type options': 'Alternativ för tabelltyp'
		}
	}
};
