...
const translations: Translations = {
	'nl': {
		dictionary: {
			...
			'Insert table layout': 'Tabellay-out invoegen',
			...
			'Table Alignment': 'Tabeluitlijning',
			...
			'Align table to the left with text wrapping': 'Tabel links uitlijnen met tekstomloop',
			...
			'Center table with no text wrapping': 'Tabel centreren zonder tekstomloop',
			...
			'Align table to the right with text wrapping': 'Tabel rechts uitlijnen met tekstomloop',
			...
			'Align table to the left with no text wrapping': 'Tabel links uitlijnen zonder tekstomloop',
			...
			'Align table to the right with no text wrapping': 'Tabel rechts uitlijnen zonder tekstomloop',
			...
			'Table type options': 'Opties voor tabeltype'
		}
	}
};
