...
const translations: Translations = {
	'pt': {
		dictionary: {
			...
			'Insert table layout': 'Inserir esquema da tabela',
			...
			'Header cell': 'célula deCabeçalho',
			...
			'Table Alignment': 'Alinhamento da Tabela',
			...
			'Align table to the left with text wrapping': 'Alinhar a tabela à esquerda e moldar texto',
			...
			'Center table with no text wrapping': 'Centrar a tabela, sem moldar texto',
			...
			'Align table to the right with text wrapping': 'Alinhar a tabela à direita e moldar texto',
			...
			'Align table to the left with no text wrapping': 'Alinhar a tabela à esquerda, sem moldar texto',
			...
			'Align table to the right with no text wrapping': 'Alinhar a tabela à direita, sem moldar texto',
			...
			'Table layout': 'Esquema da tabela',
			// The accessible label of the layout table type dropdown button.
			'Layout table': 'Tabela de esquemas',
			...
			'Choose table type': 'Escolher tipo de tabela',
			...
			'Table type options': 'Opções tipo de tabela'
		}
	}
};
