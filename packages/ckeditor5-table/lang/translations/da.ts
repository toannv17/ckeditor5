...
const translations: Translations = {
	'da': {
		dictionary: {
			...
			'Insert table layout': 'Indsæt tabellayout',
			...
			'Table Alignment': 'Tabeljustering',
			...
			'Align table to the left with text wrapping': 'Juster tabel til venstre med tekstombrydning',
			...
			'Center table with no text wrapping': 'Centrer tabel uden nogen tekstombrydning',
			...
			'Align table to the right with text wrapping': 'Juster tabel til højre med tekstombrydning',
			...
			'Align table to the left with no text wrapping': 'Juster tabel til venstre uden nogen tekstombrydning',
			...
			'Align table to the right with no text wrapping': 'Juster tabel til højre uden nogen tekstombrydning',
			...
			'Table type options': 'Indstillinger for tabeltype'
		}
	}
};
