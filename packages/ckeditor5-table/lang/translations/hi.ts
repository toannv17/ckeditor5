...
const translations: Translations = {
	'hi': {
		dictionary: {
			...
			'Insert table layout': 'टेबल लेआउट सम्मिलित करें',
			...
			'Align table to the left with text wrapping': 'टेक्स्ट रैपिंग के साथ तालिका को बाईं ओर संरेखित करें',
			...
			'Center table with no text wrapping': 'बिना टेक्स्ट रैपिंग वाली केंद्र तालिका',
			...
			'Align table to the right with text wrapping': 'टेक्स्ट रैपिंग के साथ तालिका को दाईं ओर संरेखित करें',
			...
			'Align table to the left with no text wrapping': 'बिना टेक्स्ट रैपिंग के तालिका को बाईं ओर संरेखित करें',
			...
			'Align table to the right with no text wrapping': 'बिना टेक्स्ट रैपिंग के तालिका को दाईं ओर संरेखित करें',
			...
			'Table type options': 'टेबल प्रकार के विकल्प'
		}
	}
};
