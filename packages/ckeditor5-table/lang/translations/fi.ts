...
const translations: Translations = {
	'fi': {
		dictionary: {
			...
			'Insert table layout': 'Lisää taulukon asettelu',
			...
			'Table Alignment': 'Taulukon tasaus',
			...
			'Align table to the left with text wrapping': 'Tasaa taulukko vasemmalle tekstin rivityksellä',
			...
			'Center table with no text wrapping': 'Keskitä taulukko ilman tekstin rivitystä',
			...
			'Align table to the right with text wrapping': 'Tasaa taulukko oikealle tekstin rivityksellä',
			...
			'Align table to the left with no text wrapping': 'Tasaa taulukko vasemmalle ilman tekstin rivitystä',
			...
			'Align table to the right with no text wrapping': 'Tasaa taulukko oikealle ilman tekstin rivitystä',
			...
			'Table type options': 'Taulukkotyypin vaihtoehdot'
		}
	}
};
