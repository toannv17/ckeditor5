...
const translations: Translations = {
	'el': {
		dictionary: {
			...
			'Insert table layout': 'Εισαγωγή διάταξης πίνακα',
			...
			'Table Alignment': 'Στοίχιση πίνακα',
			...
			'Align table to the left with text wrapping': 'Στοίχιση πίνακα στα αριστερά με αναδίπλωση κειμένου',
			...
			'Center table with no text wrapping': 'Κεντράρισμα πίνακα χωρίς αναδίπλωση κειμένου',
			...
			'Align table to the left with no text wrapping': 'Στοίχιση πίνακα στα αριστερά χωρίς αναδίπλωση κειμένου',
			...
			'Align table to the right with no text wrapping': 'Στοίχιση πίνακα στα δεξιά χωρίς αναδίπλωση κειμένου',
			...
			'Table type options': 'Επιλογές τύπου πίνακα'
		}
	}
};
