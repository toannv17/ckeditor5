...
const translations: Translations = {
	'be': {
		dictionary: {
			...
			'Insert code block': 'Уставіць код',
			...
			'Leaving %0 code snippet': 'Астаўляем фрагмент кода %0',
