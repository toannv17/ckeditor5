...
const translations: Translations = {
	'be': {
		dictionary: {
			...
			'Find and replace': 'Знайсці і замяніць',
			// The label for the searched text in the find and replace dropdown.
			'Find in text…': 'Знайсці ў тэксце…',
			...
			'Previous result': 'Папярэдні вынік',
			// The label for the previous result button in the find and replace dropdown.
			'Next result': 'Наступны вынік',
			...
			'Text to find must not be empty.': 'Тэкст для пошуку не павінен быць пустым.',
			// A message displayed next to the replace field when disabled but user tries to use it.
			'Tip: Find some text first in order to replace it.': 'Падказка: спачатку знайдзіце тэкст, каб замяніць яго.',
			...
			'Find in the document': 'Знайсці ў дакуменце'
		}
	}
};
