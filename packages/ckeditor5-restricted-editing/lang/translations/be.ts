...
const translations: Translations = {
	'be': {
		dictionary: {
			...
			'Enable editing': 'Уключыць рэдагаванне',
			...
			'Previous editable region': 'Папярэдняя вобласць для рэдагавання',
			// A label of the button that moves selection to the next editable region in the content.
			'Next editable region': 'Наступная вобласць для рэдагавання',
			// A label of the dropdown that provides controls to navigate editable regions in the content.
			'Navigate editable regions': 'Навігацыя па рэдагавальных абласцях'
		}
	}
};
