...
import { findClosestScrollableAncestor, global } from '@ckeditor-nonkey/ckeditor5-utils';
...
// @if CK_DEBUG_MINIMAP // import { RectDrawer } from '@ckeditor-nonkey/ckeditor5-utils/tests/_utils/rectdrawer.js';
