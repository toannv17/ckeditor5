...
import { logWarning, type LocaleTranslate } from '@ckeditor-nonkey/ckeditor5-utils';
...
import { Mention, type MentionFeed, type MentionFeedObjectItem, type MentionItemRenderer } from '@ckeditor-nonkey/ckeditor5-mention';
