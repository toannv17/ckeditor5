...
import { ButtonView, View, FocusCycler, type ViewCollection } from 'toannv-ckeditor5-ui';
import { FocusTracker, KeystrokeHandler, type Locale, type ObservableChangeEvent } from 'toannv-ckeditor5-utils';
