...
import { ButtonView, View, FocusCycler, type ViewCollection } from '@ckeditor-nonkey/ckeditor5-ui';
import { FocusTracker, KeystrokeHandler, type Locale, type ObservableChangeEvent } from '@ckeditor-nonkey/ckeditor5-utils';
